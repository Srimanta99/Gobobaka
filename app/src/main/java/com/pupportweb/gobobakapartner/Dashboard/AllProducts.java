...
import com.pupportweb.gobobakapartner.Adapter.AllProductsAdapter;
...
public class AllProducts extends AppCompatActivity {
    ...
    private TextView txtAddProduct;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtAddProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AllProducts.this,AddProductActivity.class));
            }
        });
