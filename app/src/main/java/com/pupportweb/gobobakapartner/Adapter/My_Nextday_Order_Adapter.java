...
String TAG="My_Nextday_Order_Adapter";
    String select = "false";
...
//        }
        ...
        Log.d(TAG, "onBindViewHolder: "+session_management.getCurrency());
...
//            @Override
//            public void onClick(View v) {
////                todayOrderClickListner.assignClickBoys(position, "unassign");
//            }
//        });
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
                                               @Override
                                               public void onClick(View v) {
                                                   todayOrderClickListner.forOrderNextClick(position);
                                               }
                                           });
