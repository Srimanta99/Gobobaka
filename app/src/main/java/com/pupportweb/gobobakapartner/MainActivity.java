...
import com.pupportweb.gobobakapartner.Dashboard.AllProducts;
import com.pupportweb.gobobakapartner.Dashboard.AppUserActivity;
import com.pupportweb.gobobakapartner.Dashboard.EditProfile;
import com.pupportweb.gobobakapartner.Dashboard.LoginActivity;
import com.pupportweb.gobobakapartner.Dashboard.OrdersActivity;
import com.pupportweb.gobobakapartner.Dashboard.Select_Products;
import com.pupportweb.gobobakapartner.Dashboard.StockList;
import com.pupportweb.gobobakapartner.Dashboard.StockShow;
import com.pupportweb.gobobakapartner.Fonts.CustomTypefaceSpan;
import com.pupportweb.gobobakapartner.Fragments.Home_fragment;
import com.pupportweb.gobobakapartner.NetworkConnectivity.NoInternetConnection;
import com.pupportweb.gobobakapartner.util.ConnectivityReceiver;
import com.pupportweb.gobobakapartner.util.CustomVolleyJsonRequest;
...
//        //Navigation Menu
        ...
        updateHeader();
        sideMenu();
//        new Thread(this::currency).start();
...
//            }
    ...
    private void currency() {
        ...
        CustomVolleyJsonRequest jsonObjectRequest = new CustomVolleyJsonRequest(Request.Method.GET,
                BaseURL.currency, null, new Response.Listener<JSONObject>() {
            @Override
...
//                Toast.makeText(getContext(), ""+error, Toast.LENGTH_SHORT).show();
    ...
    private void getCurrency() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET,
                BaseURL.currencyApi, response -> {
            Log.e("currencyapi", response);
            Log.e(TAG, "getCurrency: " + response.toString());
