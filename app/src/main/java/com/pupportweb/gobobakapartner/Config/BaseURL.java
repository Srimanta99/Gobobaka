package com.pupportweb.gobobakapartner.Config;
...
//    public static String BASE_URL = "https://gogrocer.tecmanic.com/api/store/";
    public static String BASE_URL = "https://gobobaka.com/admin/api/store/";
...
//    public static String BASE_URLGOGrocer = "https://gogrocer.tecmanic.com/api/";
    public static String BASE_URLGOGrocer = "https://gobobaka.com/admin/api/";
//    public static String BASE_URLGOGrocer = "https://thecodecafe.in/grocee/api/";
    ...
    public static String currency = BASE_URL + "currency";
    ...
    public static String Store_Resgister = BASE_URL + "store_register";
    ...
    public static String IMG_PRODUCT_URL = "https://gobobaka.com/admin/";
